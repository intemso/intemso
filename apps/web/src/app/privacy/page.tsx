      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-gray max-w-none">
          ...
          <ul className="list-disc pl-6 text-gray-600 space-y-3 mb-6">
            ...
            <li><strong>Gig and Contract Data:</strong> Gig postings, proposals, contract details, milestone details, deliverables, work history, ratings, reviews, and completion records.</li>
          ...
          <ul className="list-disc pl-6 text-gray-600 space-y-3 mb-6">
            ...
            <li><strong>Platform Services:</strong> To facilitate gig posting, proposal submission, contract formation, milestone management, payment processing, and communication between Users.</li>
