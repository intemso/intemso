      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-gray max-w-none">
          ...
          <ul className="list-disc pl-6 text-gray-600 space-y-3 mb-6">
            ...
            <li><strong>&quot;Connects&quot;</strong> means the virtual credits used by Students to submit proposals for available gigs on the Platform.</li>
            <li><strong>&quot;Contract&quot;</strong> means the binding work agreement formed between a Student and an Employer when the Employer accepts a Student&apos;s proposal or directly hires a Student for a gig through the Platform.</li>
            ...
            <li><strong>&quot;Gig&quot;</strong> means a task, project, job, assignment, or scope of work posted by an Employer on the Platform for which a Student may submit a proposal.</li>
            ...
            <li><strong>&quot;Proposal&quot;</strong> means a formal application submitted by a Student to an Employer in response to a posted gig, which may include a cover letter, proposed rate, estimated timeline, and any supporting materials.</li>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-10 mb-4">4. Gig Posting, Proposals, and Contract Formation</h2>
          ...
          <ul className="list-disc pl-6 text-gray-600 space-y-2 mb-6">
            ...
            <li>Creating false, misleading, or fraudulent Accounts, profiles, gig postings, proposals, reviews, or ratings.</li>
          ...
          <p className="text-gray-600 mb-4">
            The Service Fee is automatically deducted from the Student&apos;s earnings at the time of payment release. The sliding scale resets for each distinct Employer; cumulative billings are tracked separately for each Student and Employer pair. Employers are not charged any Service Fees or platform fees for posting gigs, reviewing proposals, or hiring Students. Intemso reserves the right to modify the Service Fee structure upon thirty (30) calendar days&apos; prior written notice to affected Users. Any modification to Service Fees shall apply only to Contracts formed after the effective date of the modification and shall not retroactively affect existing Contracts.
          </p>
