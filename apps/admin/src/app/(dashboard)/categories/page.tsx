  ...
  return (
    <>
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={openCreate} className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700">
          ...
          <table className="w-full min-w-[600px]">
            <thead>
              <tr className="border-b border-gray-700">
                ...
                <th className="text-center px-4 py-3 text-xs font-semibold text-gray-400 uppercase">Order</th>
                <th className="text-center px-4 py-3 text-xs font-semibold text-gray-400 uppercase">Status</th>
                <th className="text-center px-4 py-3 text-xs font-semibold text-gray-400 uppercase">Gigs</th>
            ...
            <tbody>
              {categories.map((c) => (
                <tr key={c.id} className="border-b border-gray-700/50 hover:bg-gray-700/30">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-400 font-mono">{c.slug}</td>
                  <td className="px-4 py-3 text-sm text-gray-400">{c.icon || '—'}</td>
                  <td className="px-4 py-3 text-sm text-gray-400 text-center">{c.sortOrder ?? 0}</td>
                  <td className="px-4 py-3 text-center">
                    <span className={`px-2 py-0.5 text-xs font-medium rounded-full ${c.isActive ? 'bg-green-900/50 text-green-300 border border-green-700' : 'bg-gray-700 text-gray-400'}`}>
                      {c.isActive ? 'Active' : 'Inactive'}
                    </span>
                  </td>
                  <td className="px-4 py-3 text-sm text-gray-400 text-center">{c._count?.gigs ?? 0}</td>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-gray-700 border border-gray-600 rounded-xl text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500/40"
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-gray-700 border border-gray-600 rounded-xl text-sm text-white font-mono placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500/40"
                  placeholder="web-development"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-300 mb-1">Icon (emoji/class)</label>
                <input
                  type="text"
                  value={form.icon}
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-4 py-2.5 bg-gray-700 border border-gray-600 rounded-xl text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500/40 resize-none"
                />
              </div>
              <div className="flex gap-3">
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-gray-700 border border-gray-600 rounded-xl text-sm text-white focus:outline-none focus:ring-2 focus:ring-red-500/40"
                  />
                </div>
                {modal === 'edit' && (
                  <div className="flex-1">
