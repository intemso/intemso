...
function getNotificationRoute(type: string, data: Record<string, any>): string | null {
  switch (type) {
    case 'new_application':
      return data.gigId ? `/applications?gig=${data.gigId}` : '/applications';
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 text-xs font-medium text-amber-600 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
      ...
      <div className="flex items-center gap-3 mb-4 flex-wrap">
        ...
        <button
          ...
          className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg border transition-colors ${
            typeFilter ? 'border-amber-300 bg-amber-50 text-amber-700' : 'border-gray-200 text-gray-600 hover:bg-gray-50'
          }`}
        >
