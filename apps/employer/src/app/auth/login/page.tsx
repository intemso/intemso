...
import { EyeIcon, EyeSlashIcon, EnvelopeIcon, IdentificationIcon, BriefcaseIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-linear-to-br from-blue-900/80 via-blue-800/60 to-indigo-900/70" />
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16">
          ...
          <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-6">
            Hire verified<br />student talent
          </h1>
          <p className="text-blue-100 text-lg leading-relaxed max-w-md">
            Post gigs, review proposals, and work with talented university students across Ghana.
          </p>
          <div className="mt-12 space-y-4">
            {['Access 100+ university campuses', 'Escrow-protected payments', 'Post gigs for free'].map((text) => (
      ...
      <div className="flex-1 flex items-center justify-center px-5 sm:px-8 py-12 bg-gray-50">
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 mt-1">Sign in to your employer dashboard</p>
          </div>
          ...
          <div className="mt-6 text-center space-y-3">
            <p className="text-sm text-gray-500">
              ...
              <Link href="/auth/register" className="text-blue-600 font-medium hover:underline">Create account</Link>
            </p>
            <p className="text-sm text-gray-500">
              Are you a student?{' '}
