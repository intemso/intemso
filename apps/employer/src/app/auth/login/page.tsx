          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <a href={`${process.env.NEXT_PUBLIC_MAIN_SITE_URL || 'https://intemso.com'}/auth/forgot-password`} className="text-xs font-medium text-blue-600 hover:text-blue-700 transition-colors">
                  Forgot?
                </a>
              </div>
              <div className="relative group">
